...
<div class="navbar">
    ...
    <div class="voltar" style="text-align: left;">
        <a href="../pagina_tutoria.php"><img src="../img/voltar.png" width="40" height="40"></a>
</div>
        <a href="../gerar_arquivo/gerar_1a.php"><img src="../img/excel.png" width="40" height="40"></a>
        ...
        session_start();
            ...
            $consulta = "SELECT * FROM tbalunos WHERE tutor= 'SELECIONE...'";
